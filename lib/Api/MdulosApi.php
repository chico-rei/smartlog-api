...
class MdulosApi
{
     ...
     * @return void
     */
    public function cEPsAtendidosPhpGet($cnpj, $token, $cep)
    {
        $this->cEPsAtendidosPhpGetWithHttpInfo($cnpj, $token, $cep);
    }

    /**
     * Operation cEPsAtendidosPhpGetWithHttpInfo
     *
     * Consultar se o CEP é atendido.
     *
     ...
     */
    public function cEPsAtendidosPhpGetWithHttpInfo($cnpj, $token, $cep)
    {
        $returnType = '';
        $request = $this->cEPsAtendidosPhpGetRequest($cnpj, $token, $cep);
    ...
    /**
     * Operation cEPsAtendidosPhpGetAsync
     *
     * Consultar se o CEP é atendido.
     *
     * @param  string $cnpj (required)
     ...
     */
    public function cEPsAtendidosPhpGetAsync($cnpj, $token, $cep)
    {
        return $this->cEPsAtendidosPhpGetAsyncWithHttpInfo($cnpj, $token, $cep)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation cEPsAtendidosPhpGetAsyncWithHttpInfo
     *
     * Consultar se o CEP é atendido.
     *
     * @param  string $cnpj (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function cEPsAtendidosPhpGetAsyncWithHttpInfo($cnpj, $token, $cep)
    {
        $returnType = '';
        $request = $this->cEPsAtendidosPhpGetRequest($cnpj, $token, $cep);
    ...
    /**
     * Create request for operation 'cEPsAtendidosPhpGet'
     *
     * @param  string $cnpj (required)
     * @param  string $token (required)
     * @param  string $cep (required)
     ...
     */
    protected function cEPsAtendidosPhpGetRequest($cnpj, $token, $cep)
    {
        // verify the required parameter 'cnpj' is set
        if ($cnpj === null || (is_array($cnpj) && count($cnpj) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $cnpj when calling cEPsAtendidosPhpGet'
            );
        }
        // verify the required parameter 'token' is set
        if ($token === null || (is_array($token) && count($token) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $token when calling cEPsAtendidosPhpGet'
            );
        }
        // verify the required parameter 'cep' is set
        if ($cep === null || (is_array($cep) && count($cep) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $cep when calling cEPsAtendidosPhpGet'
            );
        }

        $resourcePath = '/CEPsAtendidos.php';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // query params
        if ($cep !== null) {
            $queryParams['CEP'] = ObjectSerializer::toQueryValue($cep);
        }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function rastreamentoPhpGetAsync($cnpj, $token, $chave_n_fe = null, $conhecimento = null)
    {
        return $this->rastreamentoPhpGetAsyncWithHttpInfo($cnpj, $token, $chave_n_fe, $conhecimento)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function rastreamentoPhpGetAsyncWithHttpInfo($cnpj, $token, $chave_n_fe = null, $conhecimento = null)
    {
        $returnType = '';
    ...
    /**
     * Operation referenciaEmbarquePhpPost
     *
     * Realizar criação de código de referência de embarque
     *
     * @param  string $cnpj cnpj (required)
     * @param  string $token token (required)
     * @param  string $unidade Sigla na unidade Smartlog (required)
     * @param  \Swagger\Client\Model\Referencia $body Dados do pedido ou nota fiscal (required)
     *
     * @return array
     *@throws \InvalidArgumentException
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function referenciaEmbarquePhpPost($cnpj, $token, $unidade, $body)
    {
        return $this->referenciaEmbarquePhpPostWithHttpInfo($cnpj, $token, $unidade, $body);
    }

    /**
     * Operation referenciaEmbarquePhpPostWithHttpInfo
     *
     * Realizar criação de código de referência de embarque
     *
     * @param  string $cnpj (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function referenciaEmbarquePhpPostWithHttpInfo($cnpj, $token, $unidade, $body)
    {
        $returnType = '';
        $request = $this->referenciaEmbarquePhpPostRequest($cnpj, $token, $unidade, $body);
    ...
    /**
     * Operation referenciaEmbarquePhpPostAsync
     *
     * Realizar criação de código de referência de embarque
     *
     * @param  string $cnpj (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function referenciaEmbarquePhpPostAsync($cnpj, $token, $unidade, $body)
    {
        return $this->referenciaEmbarquePhpPostAsyncWithHttpInfo($cnpj, $token, $unidade, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation referenciaEmbarquePhpPostAsyncWithHttpInfo
     *
     * Realizar criação de código de referência de embarque
     *
     * @param  string $cnpj (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function referenciaEmbarquePhpPostAsyncWithHttpInfo($cnpj, $token, $unidade, $body)
    {
        $returnType = '';
        $request = $this->referenciaEmbarquePhpPostRequest($cnpj, $token, $unidade, $body);
    ...
    /**
     * Create request for operation 'referenciaEmbarquePhpPost'
     *
     * @param  string $cnpj (required)
     * @param  string $token (required)
     * @param  string $unidade Sigla na unidade Smartlog (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function referenciaEmbarquePhpPostRequest($cnpj, $token, $unidade, $body)
    {
        // verify the required parameter 'cnpj' is set
        if ($cnpj === null || (is_array($cnpj) && count($cnpj) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $cnpj when calling referenciaEmbarquePhpPost'
            );
        }
        // verify the required parameter 'token' is set
        if ($token === null || (is_array($token) && count($token) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $token when calling referenciaEmbarquePhpPost'
            );
        }
        // verify the required parameter 'unidade' is set
        if ($unidade === null || (is_array($unidade) && count($unidade) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $unidade when calling referenciaEmbarquePhpPost'
            );
        }
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling referenciaEmbarquePhpPost'
            );
        }

        $resourcePath = '/ReferenciaEmbarque.php';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // header params
        if ($cnpj !== null) {
            $headerParams['cnpj'] = ObjectSerializer::toHeaderValue($cnpj);
        }
        // header params
        if ($token !== null) {
        ...
        // header params
        if ($unidade !== null) {
            $headerParams['unidade'] = ObjectSerializer::toHeaderValue($unidade);
        }
